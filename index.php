...
<head>
    ...
    <title>DigiRoom Monitoring</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="index.php?page=about" class="<?php echo $page == 'about' ? 'active' : ''; ?>">About Me</a></li>
            </ul>
        </nav>
    </header>
    <div class="container">
        <div class="title">
            <h2>Pantau Suhu dan Kelembapan Ruangan <br> Secara Digital</h2>
            <div class="times">
                <span id="currentDate"><?php echo $currentDate; ?></span> |
                <span id="currentTime"><?php echo $currentTime; ?></span>
            </div>
        </div>
        <div class="content">
            <?php include $content; ?>
    ...
    <footer class="footer">
        <p>&copy; 2024 ACM. All rights reserved.</p>
    </footer>
